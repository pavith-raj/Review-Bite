...
class NewAccent : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_newaccent)
        ...
        findViewById<Button>(R.id.button_menu).setOnClickListener {
            val intent = Intent(this@NewAccent, MenuActivity::class.java)
            startActivity(intent)
        }

        // Reviews button click event
        findViewById<Button>(R.id.button_review).setOnClickListener {
            val intent = Intent(this@NewAccent, ReviewActivity::class.java)
            startActivity(intent)
        }
    }
